...
export const DEFAULT_TTS_INSTRUCTIONS = "Read this article aloud like a warm, conversational human podcast host, with steady pace, with brief pauses at headings and sentence boundaries, with subtle emphasis on key ideas, that helps the listener track complex ideas.";
